...
@Service
public class branchOfficeMigration {
  private final Logger logger;
  private final OrganizationService organizationService;


  @Autowired
  public branchOfficeMigration(@Qualifier(ServiceConstants.LOGGER_NAME) final Logger logger,
  ...
  public void branchSheetDownload(HttpServletResponse response) {
    ...
    cell1.setCellValue("Branch Office Identifier");
    ...
    response.setHeader("Content-Disposition", "inline; filename=BranchOffice.xlsx");
  ...
  public void branchSheetUpload(MultipartFile file) {
    ...
    try {
      ...
      for (int rowIndex = 1; rowIndex < rowCount; rowIndex++) {
        ...
        this.organizationService.createBranchOffice(parentIdentifier, office);
      }
